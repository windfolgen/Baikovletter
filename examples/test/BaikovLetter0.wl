...
Shrink::usage="Shrink[list] reduce a set of lists with first two same and third term different to one list with the third element to be a list of the third item of all lists.";
